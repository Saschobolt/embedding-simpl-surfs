...
Octahedron := CombSimplSurfByVertsOfFaces([ [ 1, 2, 3 ], [ 2, 5, 6 ], [ 1, 2, 5 ], [ 2, 3, 6 ], [ 1, 4, 5 ], [ 3, 4, 6 ], [ 1, 3, 4 ], [ 4, 5, 6 ] ]);
...
TriangularPrism := CombSimplSurfByVertsOfFaces([[1,2,3], [1,2,4], [2,3,5], [1,3,6], [7,2,4], [1,8,4], [7,8,4], [8,3,5], [2,9,5], [8,9,5], [7,3,6], [1,9,6], [7,9,6], [7,8,9]]);